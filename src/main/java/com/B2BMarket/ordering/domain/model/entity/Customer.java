...
import com.B2BMarket.ordering.domain.model.exception.CustomerArchivedException;
import com.B2BMarket.ordering.domain.model.valueObject.*;import com.B2BMarket.ordering.domain.model.valueObject.*;
...
import static com.B2BMarket.ordering.domain.model.exception.ErrorMessages.VALIDATION_ERROR_EMAIL_IS_INVALID;
import static com.B2BMarket.ordering.domain.model.exception.ErrorMessages.VALIDATION_ERROR_FULLNAME_IS_NULL;
...
public class Customer implements AggregateRoot<CustomerId> {
    ...
    public void addLoyaltyPoints(LoyaltyPoints pointsToAdd) {
        verifyIfChangeable();
        this.setLoyaltyPoints(this.loyaltyPoints.add(pointsToAdd));
    }
